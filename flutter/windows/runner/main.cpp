                      ...
                      _In_ wchar_t *command_line, _In_ int show_command)
{
  ...
  // Must stay in sync with `crate::get_app_name()`: the window title is also
  // used by `FindWindow` (single instance) and by `send_message_to_hnwd`.
  std::wstring app_name = L"lenovo-display";
