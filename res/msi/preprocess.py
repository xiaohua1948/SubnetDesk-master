...
def make_parser():
    ...
    parser.add_argument(
        ...
        default="",
        help=(
            "The app name shown to the user (ARP entry, dialogs, license). "
            "Defaults to --app-name. Use it when the visible name contains "
            "spaces, which --app-name cannot carry because it is also the exe, "
            "service and registry name."
        ),
    )
    parser.add_argument(
